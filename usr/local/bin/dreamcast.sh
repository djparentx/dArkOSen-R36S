...
ALSOFT_DRIVERS=alsa $ESUDO /usr/local/bin/retrorun32 -c /home/ark/.config/retrorun.cfg --triggers -s /$directory/dreamcast -d /$directory/bios /home/ark/.config/retroarch32/cores/"$2"_libretro.so "$3"
