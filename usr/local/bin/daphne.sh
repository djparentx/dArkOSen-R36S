...
if  [[ $1 == "standalone" ]]; then
  ...
  LD_PRELOAD=/opt/hypseus-singe/libSDL3.so.0.5.0 ./hypseus-singe "$basefilename" vldp -gamepad -texturestream ${RES} -framefile "$dir/$basefilename.txt" -fullscreen $extraparams
